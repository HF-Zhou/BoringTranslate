...
>`let number = 42`               &ensp;&ensp;&ensp;42
...
>**`let defaultFloat = Float()`**       &ensp;0.0
...
>`let easyPi = 3.14`          &emsp;&emsp;3.14
`let floatFromDouble = Float(easyPi)`  &ensp;3.14
